...
- **Tables:** prescribers, taxonomy_codes, practice_affiliations, credential_alerts, data_refresh_log, prescriber_pharmacy_relationships, state_prescribing_rules, dea_registrations, prescriber_exclusion_xref, medicare_part_d_utilization, medicare_opt_out.
