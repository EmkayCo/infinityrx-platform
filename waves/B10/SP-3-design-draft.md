...
**Status:** Pre-write design draft, R4 (R1 + R2 + R3 codex reviews absorbed: 9 R1 BLOCKS + 10 R1 CONCERNS + 3 R2 NEW BLOCKS + 4 R2 NEW CONCERNS + 3 R3 NEW BLOCKS + 4 R3 NEW CONCERNS addressed; 5 R1 ADVISORIES + 3 R2 ADVISORIES deferred). Pending codex R4 spec consult before formal spec write.
**Date:** 2026-05-18
**Owner:** Mike
...
**R2 review:** `docs/superpowers/codex-sp3-spec-review-r2.md` (NO-GO — partial absorption, 3 new blocks)
**R3 review:** `docs/superpowers/codex-sp3-spec-review-r3.md` (NO-GO — 12/13 absorbed YES, 1 PARTIAL, 3 new blocks for advisory-lock/contract-layer/JWT-claims)
...
**Wave control ledger:**
- This draft: `waves/B10/SP-3-design-draft.md` (R4)
- R1 review: `docs/superpowers/codex-sp3-spec-review-r1.md` (NO-GO)
- R2 review: `docs/superpowers/codex-sp3-spec-review-r2.md` (NO-GO)
- R3 review: `docs/superpowers/codex-sp3-spec-review-r3.md` (NO-GO)
- R4 review (pending): `docs/superpowers/codex-sp3-spec-review-r4.md`
- Acceptance (Plan E): `docs/sp-3-acceptance.md` (new)

---

## 12. Next steps

1. **Codex R4 spec consult** (this gate — running now after R3 absorption).
2. If R4 GO or GO-WITH-CHANGES: address any remaining findings, then write spec to `docs/superpowers/specs/2026-05-18-sp3-reclaimrx-portal-design.md` with **path verification step** (grep-verify every asserted path per R1 CONCERN 10).
3. Spec self-review (placeholder scan, internal consistency, scope, ambiguity).
4. User review gate.
5. On user approval: invoke `superpowers:writing-plans` for SP-3 plans A-E.
...
*End of pre-write design draft R4.*
