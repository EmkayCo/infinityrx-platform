...
session id: 019e1a8f-ef50-7e52-8ba9-dd2087c89409
--------
user
...
codex
I’ll verify this as a repo-local gate review: first checking the referenced artifacts and status links, then sampling the prior fix surfaces to make sure the R2 absorption did not disturb F1/F3/F4.
2026-05-12T05:01:51.411814Z ERROR codex_core::tools::router: error=`"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path waves\\B9 -File | Select-Object -ExpandProperty Name | Sort-Object"` rejected: blocked by policy
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "rg -n \"waves/B9/|waves\\\\B9\\\\|charter\\.md|plan\\.md|baseline\\.md|codex-gate-close|phase09_compat_baseline|module_base_profile|parse_warning_allowlist|write_path_enforcement|status\\.md\" waves\\B9\\status.md" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git status --short; git log -1 --oneline' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path waves\\B9 -File | Select-Object -ExpandProperty Name | Sort-Object" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
 declined in 0ms:
`"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-ChildItem -Path waves\\B9 -File | Select-Object -ExpandProperty Name | Sort-Object"` rejected: blocked by policy
 succeeded in 554ms:
...
32:| C0  | Baseline + invariants captured | (pre-session; `baseline.md` only) | — |
39:| C7  | Plan v-bump → v3.1 LOCKED (captured pre-session) | (Werkbench: `plan.md`) | — |
57:- `waves/B9/codex-gate-close-r1-prompt.md`
58:- `waves/B9/codex-gate-close-r1-result.md`
59:- `waves/B9/codex-gate-close-r2-prompt.md`
60:- `waves/B9/codex-gate-close-r2-result.md`
67:| HIGH | Wave artifacts not in repo checkout (only Werkbench) | F2 — mirrored `waves/B9/{status,parse_warning_allowlist,phase09_compat_baseline,module_base_profile,write_path_enforcement}.md` into repo |
68:| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 — `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
84:**Artifact:** `waves/B9/codex-gate-close-r2-result.md`
87:mirrored 5 artifacts referenced `charter.md`, `plan.md`,
88:`baseline.md`, and the R1 prompt/result, but those were still
91:- Mirrored `charter.md`, `plan.md`, `baseline.md` into `waves/B9/`.
92:- Mirrored `codex-gate-close-r1-prompt.md` + `codex-gate-close-r1-result.md`
93:  into `waves/B9/` so the R1 ladder is reviewable from the
95:- `status.md` "Artifacts" row updated to reflect in-repo paths.
110:Per `waves/B9/plan.md:116-127`:
113:- [x] Pytest collection node-IDs captured at baseline (waves/B9/baseline.md)
115:- [x] Phase 09 compatibility baseline established (`phase09_compat_baseline.md`)
147:Per `waves/B9/baseline.md`:
168:this file via a pointer (`see status.md row X`). They do NOT
...
?? waves/B8.1.1/
?? waves/B8/
?? waves/B9/codex-gate-close-r3-prompt.md
?? waves/B9/codex-gate-close-r3-result.md
da300b9 B9.A GATE-CLOSE R2 absorption — F2-completion (residual HIGH from R2)
warning: could not open directory '.claude/skills$skill/': No such file or directory

codex
The checkout is very dirty outside this review surface, but the requested absorption commit is the current `HEAD` (`da300b9`). I’m ignoring unrelated worktree noise and narrowing the review to `waves/B9` plus the previously accepted fix files.
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content waves\\B9\\status.md" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
exec
...
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git show --stat --oneline --name-only da300b9' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
 succeeded in 365ms:
...
## Codex GATE-CLOSE R2 â€” verdict & absorption

**Verdict:** GO-WITH-FIXES (1 HIGH residual on F2)
**Round:** R2 (2026-05-12)
**Artifact:** `waves/B9/codex-gate-close-r2-result.md`

R2 accepted F1, F3, F4 outright; flagged F2 as incomplete â€” the
...
InfinityRx checkout â€” every wave artifact named in this file
resolves to an actual in-repo path.

R3 (verification of F2-completion) **not run** in this session â€”
...
codex
The core files added by `da300b9` are present under `waves/B9`, including `charter.md`, `plan.md`, `baseline.md`, and gate-close R1/R2 prompt/result artifacts. One thing I’m checking carefully now is whether `status.md` still names any Werkbench-only artifacts outside that gate-close ladder.
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'rg --files | rg "(''^|/)(codex-plan-consult-r1|codex-adversarial-r1|codex-plan-consult-r2|codex-adversarial-r2|codex-gate-close-r1-prompt|codex-gate-close-r1-result|codex-gate-close-r2-prompt|codex-gate-close-r2-result)'"\\.md"'$"' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "rg -n \"APP_ROLES_QUOTED|ON \\{\\{SCHEMA\\}\\}\\.\\{\\{MTL_TABLES\\}\\}|ON \\{\\{MTL_TABLES\\}\\}|MTL_TABLES|load_parse_warning_allowlist|Approved allowlist entries|test_delta_contract_coverage|B9\\.B pre-opening\" infrastructure\\scripts\\lib shared\\tests modules\\drug-database\\tests waves\\B9" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Get-Content waves\\B9\\codex-gate-close-r2-result.md" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
2026-05-12T05:02:15.601849Z ERROR codex_core::tools::router: error=Exit code: 1
Wall time: 0.7 seconds
Output:

 exited 1 in 705ms:
 succeeded in 690ms:
waves\B9\codex-gate-close-r1-prompt.md:134:   placeholders `{{SCHEMA}}`, `{{MTL_TABLES}}`, `{{APP_ROLES}}`,
waves\B9\codex-gate-close-r1-prompt.md:135:   `{{APP_ROLES_QUOTED}}`. The verification block uses
waves\B9\codex-gate-close-r1-prompt.md:136:   `{{APP_ROLES_QUOTED}}` which the docstring doesn't list. Is
waves\B9\codex-gate-close-r2-prompt.md:21:- Documented `{{APP_ROLES_QUOTED}}` placeholder (was used at line 80
waves\B9\codex-gate-close-r2-prompt.md:24:  clause. Was: `ON {{SCHEMA}}.{{MTL_TABLES}}` (qualified only the
waves\B9\codex-gate-close-r2-prompt.md:25:  first table). Now: `ON {{MTL_TABLES}}` with the migration helper
waves\B9\codex-gate-close-r2-prompt.md:49:- Added `load_parse_warning_allowlist(path=None)` that reads
waves\B9\codex-gate-close-r2-prompt.md:51:  inside the "Approved allowlist entries" section (regex section-
...
waves\B9\codex-gate-close-r2-prompt.md:87:3. **F3**: is the regex anchoring on "Approved allowlist entries"
waves\B9\codex-gate-close-r2-prompt.md:91:4. **F4 deferral**: is the status-ledger row + B9.B pre-opening
waves\B9\codex-gate-close-r2-result.md:34:- Documented `{{APP_ROLES_QUOTED}}` placeholder (was used at line 80
waves\B9\codex-gate-close-r2-result.md:37:  clause. Was: `ON {{SCHEMA}}.{{MTL_TABLES}}` (qualified only the
waves\B9\codex-gate-close-r2-result.md:38:  first table). Now: `ON {{MTL_TABLES}}` with the migration helper
waves\B9\codex-gate-close-r2-result.md:62:- Added `load_parse_warning_allowlist(path=None)` that reads
waves\B9\codex-gate-close-r2-result.md:64:  inside the "Approved allowlist entries" section (regex section-
...
waves\B9\codex-gate-close-r2-result.md:100:3. **F3**: is the regex anchoring on "Approved allowlist entries"
waves\B9\codex-gate-close-r2-result.md:104:4. **F4 deferral**: is the status-ledger row + B9.B pre-opening
waves\B9\codex-gate-close-r2-result.md:802:--   {{MTL_TABLES}}        â†’ COMMA-SEPARATED SCHEMA-QUALIFIED table list.
waves\B9\codex-gate-close-r2-result.md:810:--                           `{{SCHEMA}}.{{MTL_TABLES}}` would broadcast
waves\B9\codex-gate-close-r2-result.md:818:--   {{APP_ROLES_QUOTED}}  â†’ SAME role list as {{APP_ROLES}} but with each
waves\B9\codex-gate-close-r2-result.md:838:--         .replace("{{MTL_TABLES}}", tables_qualified)
waves\B9\codex-gate-close-r2-result.md:840:--         .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
waves\B9\codex-gate-close-r2-result.md:855:-- {{MTL_TABLES}} is already a schema-qualified comma list â€” DO NOT prefix
waves\B9\codex-gate-close-r2-result.md:859:    ON {{MTL_TABLES}}
waves\B9\codex-gate-close-r2-result.md:896:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r2-result.md:916:placeholders ({{SCHEMA}}, {{MTL_TABLES}}, {{APP_ROLES}},
waves\B9\codex-gate-close-r2-result.md:917:{{APP_ROLES_QUOTED}}). The B9.G migration helper must substitute
waves\B9\codex-gate-close-r2-result.md:956:        .replace("{{MTL_TABLES}}", tables_qualified)
waves\B9\codex-gate-close-r2-result.md:958:        .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
waves\B9\codex-gate-close-r2-result.md:981:        f"All four ({{SCHEMA}}, {{MTL_TABLES}}, {{APP_ROLES}}, "
waves\B9\codex-gate-close-r2-result.md:982:        f"{{APP_ROLES_QUOTED}}) must be replaced."
waves\B9\codex-gate-close-r2-result.md:987:    """Codex HIGH 1: previous template was `ON {{SCHEMA}}.{{MTL_TABLES}}` â€” only the first table was qualified."""
waves\B9\codex-gate-close-r2-result.md:1040:        "{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}", "{{APP_ROLES_QUOTED}}"
waves\B9\codex-gate-close-r2-result.md:1083:    load_parse_warning_allowlist,
waves\B9\codex-gate-close-r2-result.md:1607:    entries = load_parse_warning_allowlist()
waves\B9\codex-gate-close-r2-result.md:1624:        "## Approved allowlist entries\n\n"
waves\B9\codex-gate-close-r2-result.md:1634:    entries = load_parse_warning_allowlist(path=fixture)
waves\B9\codex-gate-close-r2-result.md:1650:    assert load_parse_warning_allowlist(path=fixture) == frozenset()
waves\B9\codex-gate-close-r2-result.md:1657:        load_parse_warning_allowlist(path=nonexistent)
waves\B9\codex-gate-close-r2-result.md:1742:# sets. See `load_parse_warning_allowlist` below.
waves\B9\codex-gate-close-r2-result.md:1971:def load_parse_warning_allowlist(
waves\B9\codex-gate-close-r2-result.md:1988:    string, inside the "Approved allowlist entries" section).
waves\B9\codex-gate-close-r2-result.md:2009:    # Look only inside the "Approved allowlist entries" section, terminated by
waves\B9\codex-gate-close-r2-result.md:2013:        r"##\s+Approved allowlist entries\s*\n(.*?)(?=\n##\s|\Z)",
waves\B9\codex-gate-close-r2-result.md:2272:    "load_parse_warning_allowlist",
waves\B9\codex-gate-close-r2-result.md:2359:| HIGH | MTL REVOKE template `{{APP_ROLES_QUOTED}}` undocumented; `{{MTL_TABLES}}` schema-prefix bug | F1 â€” `infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl` (docs + SQL line 43 fix) + new test `tests/unit/test_fdb_mtl_revoke_template.py` (6 tests, no-placeholder-survives assertion) |
waves\B9\codex-gate-close-r2-result.md:2361:| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 â€” `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
waves\B9\codex-gate-close-r2-result.md:2364:**B9.B pre-opening obligation (F4):** Before B9.B's first Tier A
waves\B9\codex-gate-close-r2-result.md:2365:spec lands, add `test_delta_contract_coverage` to assert
waves\B9\codex-gate-close-r2-result.md:2471:## Approved allowlist entries
...
waves\B9\codex-gate-close-r2-result.md:2859:"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'rg -n -F "{{APP_ROLES_QUOTED}}" infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py; rg -n -F "ON {{MTL_TABLES}}" infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl; rg -n -F "ON {{SCHEMA}}.{{MTL_TABLES}}" infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
waves\B9\codex-gate-close-r2-result.md:2863:infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:37:--   {{APP_ROLES_QUOTED}}  → SAME role list as {{APP_ROLES}} but with each
waves\B9\codex-gate-close-r2-result.md:2864:infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:59:--         .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
waves\B9\codex-gate-close-r2-result.md:2865:infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:115:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r2-result.md:2866:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:5:{{APP_ROLES_QUOTED}}). The B9.G migration helper must substitute
waves\B9\codex-gate-close-r2-result.md:2867:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:46:        .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
waves\B9\codex-gate-close-r2-result.md:2868:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:70:        f"{{APP_ROLES_QUOTED}}) must be replaced."
waves\B9\codex-gate-close-r2-result.md:2869:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:128:        "{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}", "{{APP_ROLES_QUOTED}}"
waves\B9\codex-gate-close-r2-result.md:2870:78:    ON {{MTL_TABLES}}
waves\B9\codex-gate-close-r2-result.md:2873:infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:37:--   {{APP_ROLES_QUOTED}}  → SAME role list as {{APP_ROLES}} but with each
waves\B9\codex-gate-close-r2-result.md:2874:infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:59:--         .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
waves\B9\codex-gate-close-r2-result.md:2875:infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:115:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r2-result.md:2876:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:5:{{APP_ROLES_QUOTED}}). The B9.G migration helper must substitute
waves\B9\codex-gate-close-r2-result.md:2877:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:46:        .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
waves\B9\codex-gate-close-r2-result.md:2878:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:70:        f"{{APP_ROLES_QUOTED}}) must be replaced."
waves\B9\codex-gate-close-r2-result.md:2879:modules/drug-database/tests/unit/test_fdb_mtl_revoke_template.py:128:        "{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}", "{{APP_ROLES_QUOTED}}"
waves\B9\codex-gate-close-r2-result.md:2880:78:    ON {{MTL_TABLES}}
waves\B9\codex-gate-close-r2-result.md:2909:F1 looks acceptable: the template documents all four placeholders, uses `ON {{MTL_TABLES}}`, and the render test’s “no `{{...}}` survives” invariant is the right migration-safety check.
waves\B9\codex-gate-close-r2-result.md:2924:F1 looks acceptable: the template documents all four placeholders, uses `ON {{MTL_TABLES}}`, and the render test’s “no `{{...}}` survives” invariant is the right migration-safety check.
waves\B9\codex-gate-close-r1-result.md:147:   placeholders `{{SCHEMA}}`, `{{MTL_TABLES}}`, `{{APP_ROLES}}`,
waves\B9\codex-gate-close-r1-result.md:148:   `{{APP_ROLES_QUOTED}}`. The verification block uses
waves\B9\codex-gate-close-r1-result.md:149:   `{{APP_ROLES_QUOTED}}` which the docstring doesn't list. Is
waves\B9\codex-gate-close-r1-result.md:170:"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "rg -n \"filter_loadable_specs|FDB_LOAD_MTL|loader_group|assert_delta_semantics_acd_cycle|assert_no_parse_warnings|scan_for_collisions|_OWNED_SCHEMAS|_HARD_COLLISION_SCHEMAS|resolve_reference_db_url|APP_ROLES_QUOTED|DrugBase\\.metadata\\.tables|len\\(DrugBase\" modules shared infrastructure waves -S" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
waves\B9\codex-gate-close-r1-result.md:794:infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:80:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r1-result.md:2472:--   {{MTL_TABLES}}  â†’ comma-separated table list, e.g.
waves\B9\codex-gate-close-r1-result.md:2483:--         .replace("{{MTL_TABLES}}", ", ".join(mtl_table_names))
waves\B9\codex-gate-close-r1-result.md:2494:    ON {{SCHEMA}}.{{MTL_TABLES}}
waves\B9\codex-gate-close-r1-result.md:2531:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r1-result.md:3464:"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl' -Pattern 'Substitution placeholders|APP_ROLES|APP_ROLES_QUOTED|Usage' -Context 2,4" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
waves\B9\codex-gate-close-r1-result.md:3470:`"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl' -Pattern 'Substitution placeholders|APP_ROLES|APP_ROLES_QUOTED|Usage' -Context 2,4"` rejected: blocked by policy
waves\B9\codex-gate-close-r1-result.md:3472:2026-05-12T04:47:22.834332Z ERROR codex_core::tools::router: error=`"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "Select-String -Path 'infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl' -Pattern 'Substitution placeholders|APP_ROLES|APP_ROLES_QUOTED|Usage' -Context 2,4"` rejected: blocked by policy
waves\B9\codex-gate-close-r1-result.md:3483:"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'rg -n -C 3 "Substitution placeholders|APP_ROLES|APP_ROLES_QUOTED|Usage" "infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl"' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
waves\B9\codex-gate-close-r1-result.md:3903:21---   {{MTL_TABLES}}  → comma-separated table list, e.g.
waves\B9\codex-gate-close-r1-result.md:3914:32---         .replace("{{MTL_TABLES}}", ", ".join(mtl_table_names))
waves\B9\codex-gate-close-r1-result.md:3922:43-    ON {{SCHEMA}}.{{MTL_TABLES}}
waves\B9\codex-gate-close-r1-result.md:3939:80:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r1-result.md:3949:"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'rg -n "fdb_mtl_revoke|APP_ROLES_QUOTED|MTL_TABLES|REVOKE INSERT" modules shared infrastructure tests waves -S' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
waves\B9\codex-gate-close-r1-result.md:4287:infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:21:--   {{MTL_TABLES}}  → comma-separated table list, e.g.
waves\B9\codex-gate-close-r1-result.md:4289:infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:32:--         .replace("{{MTL_TABLES}}", ", ".join(mtl_table_names))
waves\B9\codex-gate-close-r1-result.md:4291:infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:43:    ON {{SCHEMA}}.{{MTL_TABLES}}
waves\B9\codex-gate-close-r1-result.md:4292:infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:80:      AND grantee IN ({{APP_ROLES_QUOTED}});
waves\B9\codex-gate-close-r1-result.md:4296:modules\drug-database\tests\unit\test_fdb_loader_registry.py:259:    for placeholder in ("{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}"):
waves\B9\codex-gate-close-r1-result.md:4573:    for placeholder in ("{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}"):
waves\B9\codex-gate-close-r1-result.md:4587:| HIGH | MTL REVOKE template | [fdb_mtl_revoke.sql.tmpl](</c/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:80>) uses `{{APP_ROLES_QUOTED}}`, but the documented substitution example only replaces `{{APP_ROLES}}`. A generated B9.G migration following the template docs will leave an unsubstituted placeholder and fail. Also, [line 43](</c/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:43>) qualifies only the first table if `{{MTL_TABLES}}` is an unqualified comma list. | Add `{{APP_ROLES_QUOTED}}` to documented placeholders and usage, or derive it in the migration helper. Require `{{MTL_TABLES}}` to be schema-qualified per table, or change template generation to emit `{{SCHEMA}}.table1, {{SCHEMA}}.table2`. Add a unit test that renders the template with two tables/two roles and asserts no `{{...}}` remains. |
waves\B9\codex-gate-close-r1-result.md:4609:| HIGH | MTL REVOKE template | [fdb_mtl_revoke.sql.tmpl](</c/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:80>) uses `{{APP_ROLES_QUOTED}}`, but the documented substitution example only replaces `{{APP_ROLES}}`. A generated B9.G migration following the template docs will leave an unsubstituted placeholder and fail. Also, [line 43](</c/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:43>) qualifies only the first table if `{{MTL_TABLES}}` is an unqualified comma list. | Add `{{APP_ROLES_QUOTED}}` to documented placeholders and usage, or derive it in the migration helper. Require `{{MTL_TABLES}}` to be schema-qualified per table, or change template generation to emit `{{SCHEMA}}.table1, {{SCHEMA}}.table2`. Add a unit test that renders the template with two tables/two roles and asserts no `{{...}}` remains. |
modules\drug-database\tests\_fdb_contract.py:82:# sets. See `load_parse_warning_allowlist` below.
modules\drug-database\tests\_fdb_contract.py:311:def load_parse_warning_allowlist(
modules\drug-database\tests\_fdb_contract.py:328:    string, inside the "Approved allowlist entries" section).
modules\drug-database\tests\_fdb_contract.py:349:    # Look only inside the "Approved allowlist entries" section, terminated by
modules\drug-database\tests\_fdb_contract.py:353:        r"##\s+Approved allowlist entries\s*\n(.*?)(?=\n##\s|\Z)",
modules\drug-database\tests\_fdb_contract.py:612:    "load_parse_warning_allowlist",
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:21:--   {{MTL_TABLES}}        → COMMA-SEPARATED SCHEMA-QUALIFIED table list.
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:29:--                           `{{SCHEMA}}.{{MTL_TABLES}}` would broadcast
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:37:--   {{APP_ROLES_QUOTED}}  → SAME role list as {{APP_ROLES}} but with each
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:57:--         .replace("{{MTL_TABLES}}", tables_qualified)
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:59:--         .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:74:-- {{MTL_TABLES}} is already a schema-qualified comma list — DO NOT prefix
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:78:    ON {{MTL_TABLES}}
infrastructure\scripts\lib\fdb_mtl_revoke.sql.tmpl:115:      AND grantee IN ({{APP_ROLES_QUOTED}});
modules\drug-database\tests\unit\test_fdb_contract.py:38:    load_parse_warning_allowlist,
modules\drug-database\tests\unit\test_fdb_contract.py:562:    entries = load_parse_warning_allowlist()
modules\drug-database\tests\unit\test_fdb_contract.py:579:        "## Approved allowlist entries\n\n"
modules\drug-database\tests\unit\test_fdb_contract.py:589:    entries = load_parse_warning_allowlist(path=fixture)
modules\drug-database\tests\unit\test_fdb_contract.py:605:    assert load_parse_warning_allowlist(path=fixture) == frozenset()
modules\drug-database\tests\unit\test_fdb_contract.py:612:        load_parse_warning_allowlist(path=nonexistent)
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:4:placeholders ({{SCHEMA}}, {{MTL_TABLES}}, {{APP_ROLES}},
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:5:{{APP_ROLES_QUOTED}}). The B9.G migration helper must substitute
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:44:        .replace("{{MTL_TABLES}}", tables_qualified)
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:46:        .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:69:        f"All four ({{SCHEMA}}, {{MTL_TABLES}}, {{APP_ROLES}}, "
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:70:        f"{{APP_ROLES_QUOTED}}) must be replaced."
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:75:    """Codex HIGH 1: previous template was `ON {{SCHEMA}}.{{MTL_TABLES}}` — only the first table was qualified."""
modules\drug-database\tests\unit\test_fdb_mtl_revoke_template.py:128:        "{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}", "{{APP_ROLES_QUOTED}}"
modules\drug-database\tests\unit\test_fdb_loader_registry.py:259:    for placeholder in ("{{SCHEMA}}", "{{MTL_TABLES}}", "{{APP_ROLES}}"):
waves\B9\codex-gate-close-r3-result.md:97:68:| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 — `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
waves\B9\codex-gate-close-r3-result.md:811:| HIGH | MTL REVOKE template `{{APP_ROLES_QUOTED}}` undocumented; `{{MTL_TABLES}}` schema-prefix bug | F1 â€” `infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl` (docs + SQL line 43 fix) + new test `tests/unit/test_fdb_mtl_revoke_template.py` (6 tests, no-placeholder-survives assertion) |
waves\B9\codex-gate-close-r3-result.md:813:| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 â€” `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
waves\B9\codex-gate-close-r3-result.md:816:**B9.B pre-opening obligation (F4):** Before B9.B's first Tier A
waves\B9\codex-gate-close-r3-result.md:817:spec lands, add `test_delta_contract_coverage` to assert
waves\B9\codex-gate-close-r3-result.md:932:"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "rg -n \"APP_ROLES_QUOTED|ON \\{\\{SCHEMA\\}\\}\\.\\{\\{MTL_TABLES\\}\\}|ON \\{\\{MTL_TABLES\\}\\}|MTL_TABLES|load_parse_warning_allowlist|Approved allowlist entries|test_delta_contract_coverage|B9\\.B pre-opening\" infrastructure\\scripts\\lib shared\\tests modules\\drug-database\\tests waves\\B9" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
waves\B9\parse_warning_allowlist.md:34:## Approved allowlist entries
waves\B9\status.md:66:| HIGH | MTL REVOKE template `{{APP_ROLES_QUOTED}}` undocumented; `{{MTL_TABLES}}` schema-prefix bug | F1 — `infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl` (docs + SQL line 43 fix) + new test `tests/unit/test_fdb_mtl_revoke_template.py` (6 tests, no-placeholder-survives assertion) |
waves\B9\status.md:68:| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 — `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
waves\B9\status.md:71:**B9.B pre-opening obligation (F4):** Before B9.B's first Tier A
waves\B9\status.md:72:spec lands, add `test_delta_contract_coverage` to assert
...
--------
user
# Codex B9.A mini-GATE-CLOSE R2 â€” Verification Pass

**Wave:** B9 (FDB NDDF Plus 217-table extension)
**Phase:** B9.A close (verification of R1 GO-WITH-FIXES absorption)
**Verdict requested:** GO / GO-WITH-FIXES / NO-GO
**Round 1 result:** GO-WITH-FIXES (2 HIGH + 2 MEDIUM) â€” see
`waves/B9/codex-gate-close-r1-result.md`

## What changed since R1

One absorption commit on `develop` â€” `33e858b`:

```
B9.A GATE-CLOSE R1 absorption â€” HIGH 1, HIGH 2, MEDIUM 1 (F4 deferred to B9.B)
```

Fixes applied:

### F1 â€” MTL REVOKE template (HIGH 1)
...
### F2 â€” Wave artifacts in repo (HIGH 2)
Mirrored the following from Werkbench into `waves/B9/`:
- `status.md` (the ledger)
- `parse_warning_allowlist.md` (empty initial â€” only the policy table)
...
### F3 â€” Parse-warning allowlist enforcement (MEDIUM 1)
...
- Added `load_parse_warning_allowlist(path=None)` that reads
  ...
  anchored â€” surrounding doc text and policy tables ignored).
- 4 new tests:
  * `test_allowlist_loader_returns_empty_on_repo_initial` â€” empty
    initial state is a contract (B9.A C3 ships empty)
  * `test_allowlist_loader_parses_approved_table_rows` â€” happy path
    + section-anchoring assertion (rows in "Process for adding"
    section are NOT returned)
  * `test_allowlist_loader_handles_missing_approved_section` â€”
    file without the section â†’ empty set, no error
  * `test_allowlist_loader_raises_on_missing_file` â€” empty file
    MUST exist per B9.A ship contract

### F4 â€” Delta-contract coverage assertion (MEDIUM 2)
...
as a B9.B pre-opening obligation in `waves/B9/status.md` â†’
"B9.B pre-opening obligation (F4)".

## Test result after absorption

```
B9.A cumulative tests:  116 â†’ 129 PASS (+13: 6 MTL render + 4 allowlist + 3 prior reconciliation)
drug-database unit:      326 â†’ 332 PASS, no regression
...
3. **F3**: is the regex anchoring on "Approved allowlist entries"
   ...
   renaming the H2)? If renamed, the loader returns empty â€” is
...
GO â€” B9.A closes; B9.B opens.
GO-WITH-FIXES â€” list residual HIGH / MEDIUM concerns.
NO-GO â€” fundamental issue.

For GO-WITH-FIXES, return concerns as:
| Severity | Area | Issue | Suggested fix |

codex
Iâ€™ll verify the absorption against the repository state directly: read the R1 result, inspect commit `33e858b`, check the new template/tests/artifacts, and run focused tests if the read-only sandbox allows execution.
exec
...
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'git status --short' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
 succeeded in 422ms:
33e858b (HEAD -> develop) B9.A GATE-CLOSE R1 absorption â€” HIGH 1, HIGH 2, MEDIUM 1 (F4 deferred to B9.B)
...
codex
The checkout has a very dirty tree, but `33e858b` is at `HEAD -> develop`, so Iâ€™m treating unrelated unstaged/untracked work as out of scope. The R1 result file named in the prompt is not present at `waves/B9/codex-gate-close-r1-result.md`; Iâ€™ll rely on the promptâ€™s R1 summary and verify the actual R2 artifacts.
exec
...
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command 'Get-Content -Raw modules/drug-database/tests/unit/test_fdb_contract.py' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
 succeeded in 394ms:
-- B9.A C4 Ã¢â‚¬â€ DB-level guard for FDB MTL (Medical Test Lexicon) tables.
--
...
-- by `alembic` or `run_migrations.sh` directly Ã¢â‚¬â€ B9.G generates the
...
--   {{SCHEMA}}            Ã¢â€ â€™ typically "drug_database"
--   {{MTL_TABLES}}        Ã¢â€ â€™ COMMA-SEPARATED SCHEMA-QUALIFIED table list.
...
--                           the prefix Ã¢â‚¬â€ Postgres syntax does NOT do that.
--                           Codex GATE-CLOSE R1 HIGH 1 fix.)
--   {{APP_ROLES}}         Ã¢â€ â€™ comma-separated role names (unquoted), used
--                           in REVOKE ... FROM <roles>. Example value:
--                             ifx_dev_app, ifx_mock_app, ifx_app_role_from_env
--                           (B7.3 env-driven pattern Ã¢â‚¬â€ see migrations
--                            under modules/*/alembic/versions/)
--   {{APP_ROLES_QUOTED}}  Ã¢â€ â€™ SAME role list as {{APP_ROLES}} but with each
...
-- `{{...}}` placeholders survive Ã¢â‚¬â€ the migration cannot ship with an
-- unsubstituted token.
--
...
-- revoked Ã¢â‚¬â€ reads stay open for the app-layer filter to enforce its
-- own contract.

-- 1) Revoke writes on the MTL tables themselves.
-- {{MTL_TABLES}} is already a schema-qualified comma list Ã¢â‚¬â€ DO NOT prefix
...
-- 2) Revoke USAGE on any per-table sequences (defense in depth Ã¢â‚¬â€ even
...
-- 3) Verification block Ã¢â‚¬â€ fails loudly if any app role still has
...
BEGIN
    ...
    IF bad_count > 0 THEN
        RAISE EXCEPTION
            ...
            'after REVOKE Ã¢â‚¬â€ guard FAILED. Inspect with: '
...
END $$;
 ...
 succeeded in 443ms:
"""B9.A C4 (post-gate-close F1) Ã¢â‚¬â€ Render-time tests for fdb_mtl_revoke.sql.tmpl.
...
all four Ã¢â‚¬â€ leaving any one un-substituted ships a broken migration.
...
These tests render the template with realistic inputs and assert:
  ...
  2. The REVOKE statement names every table in the input list (the
     codex bug Ã¢â‚¬â€ only the first table was being qualified Ã¢â‚¬â€ would
...
def test_revoke_statement_names_every_table() -> None:
    """Codex HIGH 1: previous template was `ON {{SCHEMA}}.{{MTL_TABLES}}` Ã¢â‚¬â€ only the first table was qualified."""
    rendered = _render(
        schema="drug_database",
    ...
    for table in ("mtl_alpha", "mtl_beta", "mtl_gamma"):
        assert f"drug_database.{table}" in rendered, (
            f"Table {table!r} missing from rendered REVOKE Ã¢â‚¬â€ schema "
...
def test_verification_block_uses_quoted_role_literals() -> None:
    """information_schema.role_table_grants.grantee is text Ã¢â‚¬â€ needs 'role' not role."""
    rendered = _render(
        schema="drug_database",
        tables=("mtl_x",),
...
def test_render_with_single_table_and_single_role() -> None:
    """Minimum-size render Ã¢â‚¬â€ degenerate cases must still substitute cleanly."""
    rendered = _render(
        schema="drug_database",
        tables=("mtl_only",),
        roles=("ifx_dev_app",),
...
def test_template_still_carries_critical_statements() -> None:
    """Sanity Ã¢â‚¬â€ F1 cleanup didn't accidentally drop the REVOKE / verification."""
    body = _TEMPLATE_PATH.read_text(encoding="utf-8")
 ...
 succeeded in 442ms:
"""B9.A C3 Ã¢â‚¬â€ Unit tests for the FDB contract-test helpers.
...
# ---------------------------------------------------------------------------
# Fixtures Ã¢â‚¬â€ synthetic FDB drop on disk
# ---------------------------------------------------------------------------
...
class _FakeModelExtraInSpec:
    """Model missing 'name' Ã¢â‚¬â€ spec has a column the model doesn't."""
...
class _FakeModelProvenanceOnlyExtras:
    """Model adds provenance columns only Ã¢â‚¬â€ should NOT fail parity."""
...
def test_latin1_decode_smoke_passes_on_valid_latin1(
    ...
    # All rows are pure ASCII (subset of latin-1) Ã¢â‚¬â€ passes.
...
def test_latin1_decode_smoke_handles_high_bytes(
    ...
    db_zip = tmp_path / "NDDF PLUS DB.zip"
    # \xb5 = Ã‚Âµ (micro sign); \x96 = en-dash in windows-1252.
    body = b"1|alpha\xb5\r\n2|beta\x96gamma\r\n"
...
def test_no_parse_warnings_FAILS_on_field_count_mismatch(
    ...
    _write_zip(
        ...
        "RFOO_TEST",
        [
            "1|alpha",        # OK Ã¢â‚¬â€ 2 fields
            "2|beta|extra",   # BAD Ã¢â‚¬â€ 3 fields, expected 2
        ],
    )
    drop = FDBDrop(
        drop_date=__import__("datetime").date(2026, 5, 6),
...
def test_no_parse_warnings_allowlist_accepts_known_skip_class(
    ...
    # `_log.warning("ingest_field_count_mismatch", extra={...})` Ã¢â‚¬â€ msg is the
...
def test_upd_transaction_codes_pass_when_all_acd(
    ...
    """The synthetic UPD has A/C/D-prefixed rows Ã¢â‚¬â€ passes."""
...
def test_upd_transaction_codes_fail_on_non_acd_prefix(
    ...
    """A non-A/C/D leading field must FAIL Ã¢â‚¬â€ table is TRUNCATE+RELOAD shape."""
    upd_zip = tmp_path / "NDDF PLUS UPD.zip"
    _write_zip(
        upd_zip,
        "RFOO_TEST",
...
class _InMemoryUpsertStore:
    ...
    def __call__(self, row: dict, tx: str) -> tuple[int, dict | None]:
        ...
        if tx == "A":
            ...
            # Real UPSERT path Ã¢â‚¬â€ overwrite.
            self._rows[k] = dict(row)
        elif tx == "D":
...
def test_delta_semantics_upsert_FAILS_on_silent_conflict_do_nothing() -> None:
    """A4 regression detector: C step is silently swallowed Ã¢â€ â€™ contract FAILS."""
    spec = TableSpec(
        table_name="RFOO",
        columns=("id", "name"),
        coercers={"id": int, "name": str},
...
def test_delta_semantics_unknown_is_skipped() -> None:
    """UNKNOWN preserves Phase 09 behavior Ã¢â‚¬â€ no contract."""
    spec = TableSpec(
        table_name="RFOO",
        columns=("id",),
        coercers={"id": int},
...
def test_allowlist_loader_returns_empty_on_repo_initial() -> None:
    ...
    # Empty initial state Ã¢â‚¬â€ no approved entries at B9.A close.
...
def test_allowlist_loader_parses_approved_table_rows(tmp_path) -> None:
    ...
    # Verify section anchoring Ã¢â‚¬â€ entries from the "Process" section
    # are NOT returned.
    assert "not_a_real_entry" not in entries


def test_allowlist_loader_handles_missing_approved_section(tmp_path) -> None:
    """File without the approved-entries section Ã¢â€ â€™ empty set, not error."""
    fixture = tmp_path / "parse_warning_allowlist.md"
    fixture.write_text(
...
def test_allowlist_loader_raises_on_missing_file(tmp_path) -> None:
    """Empty initial file MUST exist Ã¢â‚¬â€ every B9.B+ wave ships it."""
 ...
 succeeded in 444ms:
"""B9.A C3 Ã¢â‚¬â€ Reusable contract-test template for FDB ingester tables.
...
discovery does NOT pick it up as a test module Ã¢â‚¬â€ it is a helper
library. The accompanying `test_fdb_contract.py` covers the helpers
themselves.

ADVERSARIAL R1 mitigations folded in:
  * N4 (parse_table skip)        Ã¢â‚¬â€ assert_no_parse_warnings makes the
                                    "skip on field-count mismatch"
                                    branch FAIL the contract unless
                                    explicitly allowlisted.
  * A4 (delta correctness)       Ã¢â‚¬â€ assert_delta_semantics_acd_cycle
                                    ...
                                    correctness check.
  * T12 (UPD A/C/D probe)        Ã¢â‚¬â€ assert_upd_transaction_codes opens
...
The PARSE-WARNING-FAILS-TEST POLICY (charter v3.x):
  ...
  during a contract run fails the contract test for that table Ã¢â‚¬â€ UNLESS
...
def assert_schema_parity(spec: TableSpec, model_class: type) -> None:
    ...
    * Extra column in model     Ã¢â€ â€™ model writes a column the parser
                                  never populates (silent NULL).
    * Extra column in spec      Ã¢â€ â€™ parser yields a key the model can't
                                  persist (silent drop).

    The contract is set-equality. Column order is OUT OF SCOPE here
    Ã¢â‚¬â€ DDL byte-for-byte ordering is checked in alembic migration tests
...
def assert_latin1_decode_smoke(
    ...
    *,
    ...
    (e.g. micro symbol Ã‚Âµ at 0xB5, en-dash at 0x96). UTF-8 would barf;
    ...
    coercion) Ã¢â‚¬â€ pure encoding check. Failures raise UnicodeDecodeError
    ...
    for fields in _stream_pipe_rows(zip_path, spec.table_name):
        # Already decoded to str by _stream_pipe_rows Ã¢â‚¬â€ touching .encode
        ...
        if rows_seen >= sample_rows:
            break
    # No assertion on rows_seen Ã¢â‚¬â€ a small table with < sample_rows rows
...
def assert_row_count_reconciles(
    ...
    *,
    ...
    `actual_row_count` ÃƒÂ· `expected_row_count` must be within
    Ã‚Â±`tolerance_pct` (default 0.1%). Small lookups should be exact
    (tolerance hits when sentinel_filter drops a documented sentinel
    row class Ã¢â‚¬â€ e.g. RNP3 PRICE_TYPE='14').

    Lookup key: `spec.record_counts_key` if set, else `spec.table_name`.
    Missing key in RECORD_COUNTS.TXT is a contract violation Ã¢â‚¬â€ the
...
def load_parse_warning_allowlist(
    ...
    table Ã¢â‚¬â€ header text, rationale, process docs Ã¢â‚¬â€ are ignored. The
    ...
    Raises:
        FileNotFoundError: artifact missing Ã¢â‚¬â€ every B9.B+ wave must
...
def assert_upd_transaction_codes(
    ...
    *,
    ...
    from DB.zip Ã¢â‚¬â€ skip this probe in the caller.
    ...
    assert spec.has_transaction_code, (
        ...
        f"spec.has_transaction_code=False Ã¢â‚¬â€ caller should skip this probe."
    )
    ...
    assert not bad, (
        f"{spec.table_name}: UPD A/C/D probe FAIL Ã¢â‚¬â€ {len(bad)} rows in "
        f"first {rows_checked} have non-A/C/D leading field: "
        f"{bad[:5]} (sample). This table is likely TRUNCATE+RELOAD, "
        f"not UPSERT Ã¢â‚¬â€ re-classify delta_semantics."
    )
...
def assert_delta_semantics_acd_cycle(
    ...
    *,
    ...
    """Simulate A Ã¢â€ â€™ C Ã¢â€ â€™ D Ã¢â€ â€™ re-A and assert per-semantics correctness.

    ADVERSARIAL R1 A4 mitigation: an UPSERT-by-natural-key path running
    only a replay-safety test (load same row twice Ã¢â€ â€™ 0 new) gives a
    ...
    asserts on `spec.delta_semantics`:
      ...
      APPEND_ONLY:
        A Ã¢â€ â€™ C Ã¢â€ â€™ D Ã¢â€ â€™ re-A Ã¢â€ â€™ expect 4 rows (history; D + re-A are NEW
        rows in history)
      UPSERT_BY_NATURAL_KEY:
        A     Ã¢â€ â€™ 1 row with initial_row
        C     Ã¢â€ â€™ 1 row with changed_values (NOT silently ignored)
        D     Ã¢â€ â€™ 0 rows (deletion applied)
        re-A  Ã¢â€ â€™ 1 row with initial_row
      UPSERT_WITH_EFFECTIVE_DATE:
        A     Ã¢â€ â€™ 1 row at eff_date_1
        C     Ã¢â€ â€™ 2 rows (closed eff_date_1 + new eff_date_2)
        ...
        D     Ã¢â€ â€™ latest row marked terminated; caller-defined
        re-A   Ã¢â€ â€™ new row
      TRUNCATE_RELOAD:
      ...
      UNKNOWN:
        Skip Ã¢â‚¬â€ Phase 09 backward-compat (treated as APPEND_ONLY by
        downstream).
    ...
    if spec.delta_semantics in {DeltaSemantics.UNKNOWN, DeltaSemantics.TRUNCATE_RELOAD}:
        # UNKNOWN: Phase 09 compat Ã¢â‚¬â€ no contract.
    ...
    if spec.delta_semantics is DeltaSemantics.UPSERT_BY_NATURAL_KEY:
        ...
        assert state_after_c is not None and all(
            ...
            f"{spec.table_name}: C did not propagate changed_values Ã¢â‚¬â€ "
...
codex
The core code paths line up with the claimed changes so far. Iâ€™m checking the wave artifacts and the F4 deferral wording now, since the remaining gate risk is mostly whether future phases can reconstruct the close state and whether the deferred coverage obligation is easy to miss.
...
| Phase | Scope | Status | Commit range | Notes |
|---|---|---|---|---|
| B9.A | Infra + contracts | **IN PROGRESS Ã¢â‚¬â€ gate-close pending** | `503cd7b..9b61d6d` (9 commits) | C0-C14 below |
| B9.B | Tier A Ã¢â‚¬â€ 113 simple lookups | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.A gate-close |
| B9.C | Tier B Ã¢â‚¬â€ 66 NDC/GCN joins | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.B |
| B9.D | Tier C non-RNDC14 Ã¢â‚¬â€ 16 complex | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.C |
| B9.E | RNDC14 standalone | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.D |
| B9.F | Pricing big Ã¢â‚¬â€ RNP2 + RPRDPP0 | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.E |
| B9.G | MTL schema-only Ã¢â‚¬â€ 19 Tier D | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.F |
| B9.H | Cross-cutting cleanup + final gate | NOT STARTED | Ã¢â‚¬â€ | Blocked on B9.G |
...
| C# | Scope | Commit | Test count (cumulative) |
|---|---|---|---|
| C0  | Baseline + invariants captured | (pre-session; `baseline.md` only) | Ã¢â‚¬â€ |
| C1  | TableSpec registry expansion (Tier + DeltaSemantics + 4 fields) | `9b19457` | 24 (24) |
| C2  | Generated migration template (gen_fdb_tier_migration.py) | `e54425f` | 12 (36) |
| C3  | Ingester contract test template (N4/A4/T12 mitigations) | `3ead3bd` | 22 (58) |
| C4  | MTL config flag + loader registry + DB REVOKE template | `33a2fb3` | 14 (72) |
| C5  | Codex PLAN R1 consult (captured pre-session) | (Werkbench: `codex-plan-consult-r1.md`) | Ã¢â‚¬â€ |
| C6  | Codex ADVERSARIAL R1 consult (captured pre-session) | (Werkbench: `codex-adversarial-r1.md`) | Ã¢â‚¬â€ |
| C7  | Plan v-bump Ã¢â€ â€™ v3.1 LOCKED (captured pre-session) | (Werkbench: `plan.md`) | Ã¢â‚¬â€ |
| C8  | SQLite-backed DELTA_SEMANTICS simulator + A4 detector | `d6cefd8` | 8 (80) |
| C9  | Reference-DB write-path guard (env-strict + SQL assert) | `2b1f2b9` | 11 (91) |
| C10 | FDW name-collision preflight script | `c03e37a` | 16 (107) |
| C11 | setup_fdw.sh manifest-derived count + deterministic sort | `60c6cc0` | 9 (116) |
| C12 | Phase 09 compat baseline (markdown + opt-in DB test) | `9b61d6d` | 3 (119, 3 DB-skip) |
| C13 | Module base profile + lock-in test | `9b61d6d` | 3 (122) |
| C14 | This ledger (no code) | (this commit) | Ã¢â‚¬â€ |

**Cumulative B9.A new unit tests: 116 pass; 3 integration tests skip without live DB.**

---

## Codex GATE-CLOSE R1 Ã¢â‚¬â€ verdict & absorption
...
| Sev | Concern | Fix commit / location |
|---|---|---|
| HIGH | MTL REVOKE template `{{APP_ROLES_QUOTED}}` undocumented; `{{MTL_TABLES}}` schema-prefix bug | F1 Ã¢â‚¬â€ `infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl` (docs + SQL line 43 fix) + new test `tests/unit/test_fdb_mtl_revoke_template.py` (6 tests, no-placeholder-survives assertion) |
| HIGH | Wave artifacts not in repo checkout (only Werkbench) | F2 Ã¢â‚¬â€ mirrored `waves/B9/{status,parse_warning_allowlist,phase09_compat_baseline,module_base_profile,write_path_enforcement}.md` into repo |
| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 Ã¢â‚¬â€ `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
| MEDIUM | Delta-contract bypass risk (B9.B-G omitted from contract) | **F4 Ã¢â‚¬â€ deferred to B9.B opening.** Codex's own suggested fix specifies: "In B9.B, add a registry-vs-contract coverage test proving every new non-UNKNOWN/non-TRUNCATE_RELOAD TableSpec is represented in the delta contract suite." This is a B9.B C1-class commit. |
...
- [x] All cross-cutting infra commits unit-tested green (116/116 pass)
- [x] Pytest collection node-IDs captured at baseline (waves/B9/baseline.md)
- [x] `setup_fdw.sh --verify` still passes (132 PASS, 0 FAIL Ã¢â‚¬â€ captured post-B7.3)
- [x] Phase 09 compatibility baseline established (`phase09_compat_baseline.md`)
- [x] Write-path enforcement verified (write_path_guard tests 11/11 + smoke exit-1)
- [x] FDW name-collision preflight script in place + 16/16 tests pass
- [x] DB-level MTL guard template emitted (`fdb_mtl_revoke.sql.tmpl`)
...
|---|---|---|
| SC-1 | 217 tables have models + migrations + ingester | **+0** (B9.B-G lands actual tables) |
| SC-2 | RECORD_COUNTS reconciliation (within Ã‚Â±0.1%) | Contract template ready (C3); per-table assertions land B9.B+ |
| SC-3 | DELTA_SEMANTICS per table | Enum + contract (C1+C3+C8) ready; per-table assignment B9.B+ |
| SC-4 | Phase 09 untouched (row counts, query latency) | Baseline locked (C12); test runs every gate |
| SC-5 | Generated migration shape (idempotent up+down+up) | Generator + tests (C2) ready |
| SC-6 | FDW verify count grows additively | Manifest-derived count (C11) ready; floor 66 |
...
1. **195 pre-existing test failures** Ã¢â‚¬â€ out of B9 scope per charter
   Ã‚Â§Out-of-scope row 3 ("134 pre-existing test failures (forensic wave)").
   The +61 vs prior memory was resolved by B7.3 (commit `503cd7b`).
2. **tests/integration collection error** Ã¢â‚¬â€ pre-existing plugin
   registration conflict; forensic wave fixes.
3. **Second-run flake snapshot** Ã¢â‚¬â€ DEFERRED to next Docker-up session.
...
* When a B9.A C# commit lands Ã¢â‚¬â€ append the commit row.
* When a phase enters / exits / blocks Ã¢â‚¬â€ update the phase ledger row.
* When a charter SC moves status Ã¢â‚¬â€ update the SC mapping row.
* At every mini-GATE-CLOSE Ã¢â‚¬â€ append the per-phase evidence section.

Memory entries (`~/.claude/.../memory/project_b9_*.md`) reference
this file via a pointer (`see status.md row X`). They do NOT
duplicate state Ã¢â‚¬â€ that creates two-source-of-truth drift.
...
the helper `assert_no_parse_warnings()` defaults to ZERO tolerance Ã¢â‚¬â€
...
2. Reproduce the warning locally and confirm the affected row class
   ...
   thrashing).
3. Write a short rationale ("PRICE_TYPE='14' NOPRC sentinel Ã¢â‚¬â€ 0.02%
   of RNP3 rows, documented in Ã‚Â§4.4").
...
(empty Ã¢â‚¬â€ no entries approved as of B9.A C3)
...
NOT a free pass** Ã¢â‚¬â€ every entry expands the surface where the
parser can silently drop rows. Treat additions as a recorded
decision, not a routine extension.


 succeeded in 592ms:
# B9.A C12 Ã¢â‚¬â€ Phase 09 Compatibility Baseline
...
A regression in any of these is a hard stop Ã¢â‚¬â€ B9 must not have
...
| `drug_database.fdb_ndc_price_type_desc` | (TBD Ã¢â‚¬â€ capture next Docker session) | RNPTYPD0_NDC_PRICE_TYPE_DESC |

Tolerance: **exact match** for `fdb_price_type_desc` (static reference,
23 rows defined by spec). Weekly delta growth allowed for
`fdb_ndc_price_history` Ã¢â‚¬â€ separately tracked in the weekly delta
...
Captured timing: **2.116 ms** (index hit; result was 0 rows Ã¢â‚¬â€ that
...
- rnp3_inserted = 0 (already current Ã¢â‚¬â€ last weekly applied)
...
1. **Env-var:** `DATABASE_URL_SYNC_REFERENCE` is set to a Postgres
   ...
   (`DATABASE_URL_SYNC_REFERENCE Ã¢â€ â€™ DATABASE_URL_SYNC Ã¢â€ â€™ DATABASE_URL`)
...
- **Env-var only.** Operator runs `switch_env.sh dev` (correctly sets
  ...
  Postgres cluster for an unrelated task Ã¢â‚¬â€ `DATABASE_URL_SYNC_REFERENCE`
...
exception, NOT a quiet edit to the env-var resolver.
 ...
 succeeded in 609ms:
# B9.A C13 Ã¢â‚¬â€ Module-Level Declarative Base / Metadata Profile
...
The 8Ãƒâ€” growth in import time would be paid by EVERY test in the
drug-database module that imports `DrugBase` Ã¢â‚¬â€ including unit tests
...
# One MetaData Ã¢â€ â€™ all tables share the same schema namespace
# (drug_database) for alembic / FDW purposes.
fdb_metadata = MetaData(schema="drug_database")


class FDBBase(DeclarativeBase):
    """Common base for any cross-tier FDB model Ã¢â‚¬â€ pricing, RNDC14."""
...
#   import nothing from .fdb Ã¢â‚¬â€ DrugBase stays at 9 tables
```
...
4 metadata objects Ã¢â‚¬â€ strictly worse than the current single-chain
...
A SQLAlchemy declarative base is the IMPORT seam Ã¢â‚¬â€ importing the
...
09 `DrugBase` re-exposes `fdb_metadata` (cleaner Ã¢â‚¬â€ preserves
...
1. `len(DrugBase.metadata.tables) == 9` Ã¢â‚¬â€ the Phase 09 surface.
...
The test does NOT measure wall-clock import time Ã¢â‚¬â€ too noisy for
...
codex
One material gap is emerging: `waves/B9/status.md` now exists, but it still points to repo-local `charter.md`, `plan.md`, `baseline.md`, and R1 artifacts that are not present under `waves/B9/`. That matters for the â€œreconstruct from checkout aloneâ€ criterion, so Iâ€™m checking focused tests before assigning severity.
...
Output:
infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:37:--   {{APP_ROLES_QUOTED}}  â†’ SAME role list as {{APP_ROLES}} but with each
infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:59:--         .replace("{{APP_ROLES_QUOTED}}", roles_quoted)
infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl:115:      AND grantee IN ({{APP_ROLES_QUOTED}});
...
waves/B9\codex-gate-close-r2-result.md:772:The checkout has a very dirty tree, but `33e858b` is at `HEAD -> develop`, so Iâ€™m treating unrelated unstaged/untracked work as out of scope. The R1 result file named in the prompt is not present at `waves/B9/codex-gate-close-r1-result.md`; Iâ€™ll rely on the promptâ€™s R1 summary and verify the actual R2 artifacts.
...
F1 looks acceptable: the template documents all four placeholders, uses `ON {{MTL_TABLES}}`, and the render testâ€™s â€œno `{{...}}` survivesâ€ invariant is the right migration-safety check.
...
2026-05-12T05:02:34.748820Z ERROR codex_core::tools::router: error=`"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "@('waves/B9/charter.md','waves/B9/plan.md','waves/B9/baseline.md','waves/B9/codex-gate-close-r1-prompt.md','waves/B9/codex-gate-close-r1-result.md','waves/B9/codex-gate-close-r2-prompt.md','waves/B9/codex-gate-close-r2-result.md','waves/B9/phase09_compat_baseline.md','waves/B9/module_base_profile.md','waves/B9/parse_warning_allowlist.md','waves/B9/write_path_enforcement.md','codex-plan-consult-r1.md','codex-adversarial-r1.md') | ForEach-Object { \""'$($_)`t$(Test-Path $_)" }'` rejected: blocked by policy
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "rg -n \"Werkbench|codex-plan|codex-adversarial|SPEC R1|PLAN R1|ADVERSARIAL R1\" waves\\B9\\status.md waves\\B9\\plan.md waves\\B9\\charter.md waves\\B9\\baseline.md" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "@('waves/B9/charter.md','waves/B9/plan.md','waves/B9/baseline.md','waves/B9/codex-gate-close-r1-prompt.md','waves/B9/codex-gate-close-r1-result.md','waves/B9/codex-gate-close-r2-prompt.md','waves/B9/codex-gate-close-r2-result.md','waves/B9/phase09_compat_baseline.md','waves/B9/module_base_profile.md','waves/B9/parse_warning_allowlist.md','waves/B9/write_path_enforcement.md','codex-plan-consult-r1.md','codex-adversarial-r1.md') | ForEach-Object { \""'$($_)`t$(Test-Path $_)" }' in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
 declined in 0ms:
`"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "@('waves/B9/charter.md','waves/B9/plan.md','waves/B9/baseline.md','waves/B9/codex-gate-close-r1-prompt.md','waves/B9/codex-gate-close-r1-result.md','waves/B9/codex-gate-close-r2-prompt.md','waves/B9/codex-gate-close-r2-result.md','waves/B9/phase09_compat_baseline.md','waves/B9/module_base_profile.md','waves/B9/parse_warning_allowlist.md','waves/B9/write_path_enforcement.md','codex-plan-consult-r1.md','codex-adversarial-r1.md') | ForEach-Object { \""'$($_)`t$(Test-Path $_)" }'` rejected: blocked by policy
exec
"C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Command "rg -n \"GO-WITH-FIXES|F2|F1|F3|F4|ACCEPTED|INCOMPLETE|Verdict\" waves\\B9\\codex-gate-close-r1-result.md waves\\B9\\codex-gate-close-r2-result.md waves\\B9\\codex-gate-close-r2-prompt.md" in C:\Users\MK\Desktop\Code Projects\InfinityRx\infinityrx-platform
 succeeded in 384ms:
...
waves\B9\status.md:9:**Codex consult artifacts:** SPEC R1/R2/R3, PLAN R1/R2, ADVERSARIAL R1/R2
waves\B9\status.md:37:| C5  | Codex PLAN R1 consult (captured pre-session) | (Werkbench: `codex-plan-consult-r1.md`) | — |
waves\B9\status.md:38:| C6  | Codex ADVERSARIAL R1 consult (captured pre-session) | (Werkbench: `codex-adversarial-r1.md`) | — |
waves\B9\status.md:39:| C7  | Plan v-bump → v3.1 LOCKED (captured pre-session) | (Werkbench: `plan.md`) | — |
waves\B9\status.md:67:| HIGH | Wave artifacts not in repo checkout (only Werkbench) | F2 — mirrored `waves/B9/{status,parse_warning_allowlist,phase09_compat_baseline,module_base_profile,write_path_enforcement}.md` into repo |
waves\B9\status.md:89:Werkbench-only. F2-completion (same session as R2):
waves\B9\status.md:94:  InfinityRx checkout alone (no Werkbench dependency).
waves\B9\status.md:120:- [x] Codex PLAN R1+R2 + ADVERSARIAL R1+R2 verdicts captured + addressed
...
waves\B9\plan.md:32:## ADVERSARIAL R1 mitigations folded in (all 9 HIGH + 11 MEDIUM + 4 novel)
waves\B9\plan.md:34:Each codex ADVERSARIAL R1 attack with its plan v3 response. Maps to threats T13-T32 below.
waves\B9\plan.md:72:8. **`charter.md` v3 + `recon.md` checked into Werkbench/projects/infinityrx-platform/waves/B9/** at the moment B9.A starts (commit reference required in B9.A C0 evidence).
waves\B9\plan.md:73:9. **Codex consult ledger ready** — `codex-plan-consult-r1.md` slot reserved; `codex-adversarial-r1.md` slot reserved.
waves\B9\plan.md:105:| C5 | Codex PLAN R1 consult dispatched, verdict captured | `waves/B9/codex-plan-consult-r1.md` |
waves\B9\plan.md:106:| C6 | Codex ADVERSARIAL R1 consult dispatched, verdict captured | `waves/B9/codex-adversarial-r1.md` |
waves\B9\plan.md:126:- Codex PLAN R1 + R2 + ADVERSARIAL R1 + R2 verdicts all captured; all HIGH/MEDIUM objections addressed.
waves\B9\plan.md:335:- Session 1: Manifest expansion — `expected_reference_tables.txt` final count locked at **264** (charter v3.2 SC-6 default; MTL excluded). Update Werkbench inventory + glossary if new tables/concepts warrant.
...
waves\B9\plan.md:432:| SPEC R1 | B9.A | Charter v1 dispatched 2026-05-11 | `codex-spec-consult-r1.md` — GO-WITH-FIXES |
waves\B9\plan.md:434:| PLAN R1 | B9.A | Plan v1 dispatched 2026-05-11 | `codex-plan-consult-r1.md` — GO-WITH-FIXES (8 fixes) |
...
waves\B9\plan.md:436:| ADVERSARIAL R1 | B9.A | Plan v2 LOCKED dispatched 2026-05-11 | `codex-adversarial-r1.md` — HIGH-SEVERITY OBJECTIONS PRESENT (9 HIGH + 11 MED + 4 novel) |
...
waves\B9\plan.md:464:## Errata resolved by codex PLAN R1 (kept for traceability)

 succeeded in 364ms:
waves\B9\codex-gate-close-r2-prompt.md:4:**Phase:** B9.A close (verification of R1 GO-WITH-FIXES absorption)
waves\B9\codex-gate-close-r2-prompt.md:5:**Verdict requested:** GO / GO-WITH-FIXES / NO-GO
waves\B9\codex-gate-close-r2-prompt.md:6:**Round 1 result:** GO-WITH-FIXES (2 HIGH + 2 MEDIUM) — see
waves\B9\codex-gate-close-r2-prompt.md:14:B9.A GATE-CLOSE R1 absorption — HIGH 1, HIGH 2, MEDIUM 1 (F4 deferred to B9.B)
waves\B9\codex-gate-close-r2-prompt.md:19:### F1 — MTL REVOKE template (HIGH 1)
waves\B9\codex-gate-close-r2-prompt.md:37:### F2 — Wave artifacts in repo (HIGH 2)
waves\B9\codex-gate-close-r2-prompt.md:47:### F3 — Parse-warning allowlist enforcement (MEDIUM 1)
waves\B9\codex-gate-close-r2-prompt.md:64:### F4 — Delta-contract coverage assertion (MEDIUM 2)
waves\B9\codex-gate-close-r2-prompt.md:68:"B9.B pre-opening obligation (F4)".
waves\B9\codex-gate-close-r2-prompt.md:80:1. **F1**: does the new MTL template substitution recipe correctly
waves\B9\codex-gate-close-r2-prompt.md:84:2. **F2**: are the in-repo `waves/B9/` artifacts complete enough
waves\B9\codex-gate-close-r2-prompt.md:87:3. **F3**: is the regex anchoring on "Approved allowlist entries"
waves\B9\codex-gate-close-r2-prompt.md:91:4. **F4 deferral**: is the status-ledger row + B9.B pre-opening
waves\B9\codex-gate-close-r2-prompt.md:95:## Verdict format
waves\B9\codex-gate-close-r2-prompt.md:98:GO-WITH-FIXES — list residual HIGH / MEDIUM concerns.
waves\B9\codex-gate-close-r2-prompt.md:101:For GO-WITH-FIXES, return concerns as:
waves\B9\codex-gate-close-r2-result.md:17:**Phase:** B9.A close (verification of R1 GO-WITH-FIXES absorption)
waves\B9\codex-gate-close-r2-result.md:18:**Verdict requested:** GO / GO-WITH-FIXES / NO-GO
waves\B9\codex-gate-close-r2-result.md:19:**Round 1 result:** GO-WITH-FIXES (2 HIGH + 2 MEDIUM) — see
waves\B9\codex-gate-close-r2-result.md:27:B9.A GATE-CLOSE R1 absorption — HIGH 1, HIGH 2, MEDIUM 1 (F4 deferred to B9.B)
waves\B9\codex-gate-close-r2-result.md:32:### F1 — MTL REVOKE template (HIGH 1)
waves\B9\codex-gate-close-r2-result.md:50:### F2 — Wave artifacts in repo (HIGH 2)
waves\B9\codex-gate-close-r2-result.md:60:### F3 — Parse-warning allowlist enforcement (MEDIUM 1)
waves\B9\codex-gate-close-r2-result.md:77:### F4 — Delta-contract coverage assertion (MEDIUM 2)
waves\B9\codex-gate-close-r2-result.md:81:"B9.B pre-opening obligation (F4)".
waves\B9\codex-gate-close-r2-result.md:93:1. **F1**: does the new MTL template substitution recipe correctly
waves\B9\codex-gate-close-r2-result.md:97:2. **F2**: are the in-repo `waves/B9/` artifacts complete enough
waves\B9\codex-gate-close-r2-result.md:100:3. **F3**: is the regex anchoring on "Approved allowlist entries"
waves\B9\codex-gate-close-r2-result.md:104:4. **F4 deferral**: is the status-ledger row + B9.B pre-opening
waves\B9\codex-gate-close-r2-result.md:108:## Verdict format
waves\B9\codex-gate-close-r2-result.md:111:GO-WITH-FIXES — list residual HIGH / MEDIUM concerns.
waves\B9\codex-gate-close-r2-result.md:114:For GO-WITH-FIXES, return concerns as:
...
waves\B9\codex-gate-close-r2-result.md:913:"""B9.A C4 (post-gate-close F1) â€” Render-time tests for fdb_mtl_revoke.sql.tmpl.
waves\B9\codex-gate-close-r2-result.md:1033:    """Sanity â€” F1 cleanup didn't accidentally drop the REVOKE / verification."""
waves\B9\codex-gate-close-r2-result.md:2279:The core code paths line up with the claimed changes so far. I’m checking the wave artifacts and the F4 deferral wording now, since the remaining gate risk is mostly whether future phases can reconstruct the close state and whether the deferred coverage obligation is easy to miss.
waves\B9\codex-gate-close-r2-result.md:2349:**Verdict:** GO-WITH-FIXES (2 HIGH + 2 MEDIUM)
waves\B9\codex-gate-close-r2-result.md:2359:| HIGH | MTL REVOKE template `{{APP_ROLES_QUOTED}}` undocumented; `{{MTL_TABLES}}` schema-prefix bug | F1 â€” `infrastructure/scripts/lib/fdb_mtl_revoke.sql.tmpl` (docs + SQL line 43 fix) + new test `tests/unit/test_fdb_mtl_revoke_template.py` (6 tests, no-placeholder-survives assertion) |
waves\B9\codex-gate-close-r2-result.md:2360:| HIGH | Wave artifacts not in repo checkout (only Werkbench) | F2 â€” mirrored `waves/B9/{status,parse_warning_allowlist,phase09_compat_baseline,module_base_profile,write_path_enforcement}.md` into repo |
waves\B9\codex-gate-close-r2-result.md:2361:| MEDIUM | Parse-warning allowlist policy unenforced (free `Iterable[str]`) | F3 â€” `load_parse_warning_allowlist()` helper in `_fdb_contract.py` + 4 tests; the helper reads `waves/B9/parse_warning_allowlist.md` and returns only entries inside the "Approved" table block, section-anchored |
...
waves\B9\codex-gate-close-r2-result.md:2826:    (?:codex-gate-close-r1|B9.B pre-opening|test_delta_contract_coverage|F4|Approved allowlist entries|{{APP_ROLES_QUOTED}}|ON {{MTL_TABLES}}|ON {{SCHEMA}}\.{{MTL_TABLES}})
waves\B9\codex-gate-close-r2-result.md:2834:    (?:codex-gate-close-r1|B9.B pre-opening|test_delta_contract_coverage|F4|Approved allowlist entries|{{APP_ROLES_QUOTED}}|ON {{MTL_TABLES}}|ON {{SCHEMA}}\.{{MTL_TABLES}})
waves\B9\codex-gate-close-r2-result.md:2903:GO-WITH-FIXES
waves\B9\codex-gate-close-r2-result.md:2907:| HIGH | F2 artifacts | The repo still cannot reconstruct B9.A close from checkout alone. [status.md](</C:/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/waves/B9/status.md:6>) references `waves/B9/charter.md`, `plan.md`, and `baseline.md`, but those files are absent. It also references `waves/B9/codex-gate-close-r1-result.md` as a Werkbench artifact at [status.md](</C:/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/waves/B9/status.md:58>), and that file is not present in-repo. This means F2 only partially absorbed the R1 HIGH. | Mirror at least `charter.md`, `plan.md`, `baseline.md`, `codex-gate-close-r1-prompt.md`, and `codex-gate-close-r1-result.md` into `waves/B9/`, or revise `status.md` so every required close artifact points to an actual in-repo path. |
waves\B9\codex-gate-close-r2-result.md:2909:F1 looks acceptable: the template documents all four placeholders, uses `ON {{MTL_TABLES}}`, and the render test’s “no `{{...}}` survives” invariant is the right migration-safety check.
waves\B9\codex-gate-close-r2-result.md:2911:F3 is acceptable as a conservative failure mode. If the approved section is renamed, the loader returns an empty allowlist; that may cause false failures, but it does not silently permit parse drops.
...
waves\B9\codex-gate-close-r2-result.md:2918:GO-WITH-FIXES
waves\B9\codex-gate-close-r2-result.md:2922:| HIGH | F2 artifacts | The repo still cannot reconstruct B9.A close from checkout alone. [status.md](</C:/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/waves/B9/status.md:6>) references `waves/B9/charter.md`, `plan.md`, and `baseline.md`, but those files are absent. It also references `waves/B9/codex-gate-close-r1-result.md` as a Werkbench artifact at [status.md](</C:/Users/MK/Desktop/Code Projects/InfinityRx/infinityrx-platform/waves/B9/status.md:58>), and that file is not present in-repo. This means F2 only partially absorbed the R1 HIGH. | Mirror at least `charter.md`, `plan.md`, `baseline.md`, `codex-gate-close-r1-prompt.md`, and `codex-gate-close-r1-result.md` into `waves/B9/`, or revise `status.md` so every required close artifact points to an actual in-repo path. |
waves\B9\codex-gate-close-r2-result.md:2924:F1 looks acceptable: the template documents all four placeholders, uses `ON {{MTL_TABLES}}`, and the render test’s “no `{{...}}` survives” invariant is the right migration-safety check.
waves\B9\codex-gate-close-r2-result.md:2926:F3 is acceptable as a conservative failure mode. If the approved section is renamed, the loader returns an empty allowlist; that may cause false failures, but it does not silently permit parse drops.
...
waves\B9\codex-gate-close-r1-result.md:18:**Verdict requested:** GO / GO-WITH-FIXES / NO-GO
waves\B9\codex-gate-close-r1-result.md:152:## Verdict format
waves\B9\codex-gate-close-r1-result.md:157:- **GO-WITH-FIXES** — list of HIGH / MEDIUM concerns; B9.A re-opens
waves\B9\codex-gate-close-r1-result.md:161:For GO-WITH-FIXES, return concerns in the format:
waves\B9\codex-gate-close-r1-result.md:4583:**Verdict: GO-WITH-FIXES**
waves\B9\codex-gate-close-r1-result.md:4605:**Verdict: GO-WITH-FIXES**
...
| Severity | Area | Issue | Suggested fix |
|---|---|---|---|
| MEDIUM | Artifact closure | The R2 HIGH is substantially absorbed: `charter.md`, `plan.md`, `baseline.md`, and gate-close R1/R2 prompt/result files are now present in `waves/B9/`. However, [waves/B9/status.md](/C:/Users/MK/Desktop/Code%20Projects/InfinityRx/infinityrx-platform/waves/B9/status.md:37) still names Werkbench-only consult artifacts: `codex-plan-consult-r1.md` and `codex-adversarial-r1.md`. [waves/B9/plan.md](/C:/Users/MK/Desktop/Code%20Projects/InfinityRx/infinityrx-platform/waves/B9/plan.md:105) also expects `waves/B9/codex-plan-consult-r1.md` and `waves/B9/codex-adversarial-r1.md`. That means the stricter “every named path resolves in-repo” criterion is not yet fully true. | Either mirror the missing PLAN/ADVERSARIAL consult artifacts into `waves/B9/`, or revise `status.md`/`plan.md` so those entries are summaries rather than unresolved artifact paths. |

F1, F3, and F4 remain accepted. The MTL REVOKE template still documents/substitutes `{{APP_ROLES_QUOTED}}` and uses `ON {{MTL_TABLES}}`; parse-warning allowlist enforcement is still present; F4 remains explicitly documented as a B9.B pre-opening obligation.

I did not rerun the pytest suites in this read-only/tool-policy context; this verdict is based on repository inspection.
tokens used
50,243
GO-WITH-FIXES
