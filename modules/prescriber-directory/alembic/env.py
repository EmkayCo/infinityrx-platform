"""Alembic environment for prescriber-directory.

Imports shared.db.base metadata and all prescriber_dir ORM models so that
autogenerate sees the full schema for migrations.

LESSON-011: prescriber_dir tables are global reference — no TenantScopedMixin.
"""
...
from src.models.nppes_tables import (  # noqa: F401
...
# Use PrescriberBase metadata (all prescriber_dir tables)
target_metadata = PrescriberBase.metadata
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table_schema="prescriber_dir",
    )
