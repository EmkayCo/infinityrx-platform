"""paysync RLS tenant isolation.

Applies row-level security policies to all 7 paysync tables per the
Wave 20 B2 / platform RLS pattern. Every paysync table is
...
Revision ID: 0002_paysync_rls
Revises: 0001_paysync_baseline
...
revision: str = "0002_paysync_rls"
down_revision: Union[str, None] = "0001_paysync_baseline"
