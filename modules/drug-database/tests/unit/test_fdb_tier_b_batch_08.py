"""B9.C Tier B batch 08 contract tests (schema-only scaffold).

Covers: RPEIRR0, RRTGNGC0, RRTGNND0, RTMDFCG0, RTMMICG0, RTMNCG0, RTMNID0, RTMNMCG0, RTMRMCG0.
...
from drug_database.services.fdb_tier_b.batch_08 import SPECS
