"""Integration tests for the /health endpoint in the reporting module.

Verifies real dependency checks through create_app() per LESSON-006.
Database is a critical dependency — 503 when down.
Reporting does not use Redis, so no redis dependency check.
"""
