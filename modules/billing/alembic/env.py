"""Alembic environment for billing module.

Imports shared.db.base metadata and all billing ORM models so that
autogenerate sees the full schema for migrations.

LESSON-011: billing tables ARE tenant-scoped transactional data.
ClaimRecord has a tenant_id column — do NOT drop it.
"""
...
# Use BillingBase metadata (all billing tables)
