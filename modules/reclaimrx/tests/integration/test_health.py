"""Integration tests for the /health endpoint in the reclaimrx module.

Verifies real dependency checks through create_app() per LESSON-006.
Database is a critical dependency — 503 when down.
ReclaimRx does not use Redis, so no redis dependency check.
"""
