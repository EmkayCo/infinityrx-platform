...
const PAYSYNC_ROUTES = [
  ...
  { path: "/admin/paysync/cycle-schedules", heading: /cycle schedules/i },
  { path: "/admin/paysync/export-templates", heading: /export templates/i },
  { path: "/admin/paysync/email-templates", heading: /email templates/i },
  { path: "/admin/paysync/email-recipients", heading: /email recipients/i },
  { path: "/admin/paysync/gl-account-mappings", heading: /gl account mappings/i },
  { path: "/admin/paysync/invoice-sequences", heading: /invoice sequences/i },
