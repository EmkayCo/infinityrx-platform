...
const ROUTES: { module: string; route: string }[] = [
  ...
  { module: "PaySyncConfig", route: "/admin/paysync/setup" },
  { module: "PaySyncConfig", route: "/admin/paysync/setup/cycle-schedules" },
  { module: "PaySyncConfig", route: "/admin/paysync/setup/export-templates" },
  { module: "PaySyncConfig", route: "/admin/paysync/setup/email-templates" },
  { module: "PaySyncConfig", route: "/admin/paysync/setup/email-recipients" },
  { module: "PaySyncConfig", route: "/admin/paysync/setup/gl-account-mappings" },
  { module: "PaySyncConfig", route: "/admin/paysync/setup/invoice-sequences" },
