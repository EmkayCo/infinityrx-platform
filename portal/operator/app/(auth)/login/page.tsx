...
// LoginContent owns all state that depends on useSearchParams().
// Extracted into a child component so the parent shell can wrap it in
// <Suspense>. Next.js App Router requires Suspense around useSearchParams()
// for static rendering; without it, every /login?callbackUrl=... navigation
// triggers React hydration error #418/#423. (F-004)
...
// LoginPage is the static shell. It wraps LoginContent in <Suspense> so
// Next.js App Router can statically render this route even when
// useSearchParams() is called inside LoginContent.
