/**
 * GET /api/paysync/invoices -- list invoices (status/client filter + cursor pagination)
 *
...
import { handleListInvoices } from "@infinityrx/module-paysync/bff";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await handleListInvoices(bffReq, client);
    ...
    return NextResponse.json(
      { error: { code: "UPSTREAM_ERROR", message: "Failed to list invoices" } },
